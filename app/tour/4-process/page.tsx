...
import { Calendar, Users, FileText, MessageCircle, BarChart3, CheckCircle2, type LucideIcon } from "lucide-react";
...
export default function Step4ProcessPage() {
  ...
  return (
    <>
      <StepShell step={step}>
        {/* Horizontal phase selector — works as a timeline */}
